...
def detect_and_predict_mask(frame, faceNet, maskNet):
	...
	for i in range(0, detections.shape[2]):
		...
		if conf > confidence:
			...
			face_landmark = cv2.resize(face, (96, 96))
			face_landmark = img_to_array(face_landmark)
			face_landmark = preprocess_input(face_landmark)
	...
	if len(faces) > 0:
		...
		landmarks = landmarkNet.predict(face_landmarks, batch_size = 32)
